...
<body>
  ...
  <div>
    ...
    <div>
      ...
      <div>
        <img width="200px" src= "https://media.istockphoto.com/photos/-picture-id177305558?s=612x612">
      </div>
 <div>
   ...
   <div>
        <h2>With color this time - begin CSS</h2>
          <table>
              <td>
                <ul>
          <li class="foodLi">Thing not-necessarily-one</li>
          <li class="foodLi">Thing not-necessarily-two</li>
          <li class="foodLi">Thing not-necessarily-three</li>
                </ul>
            </td>
               <td>
                  <ol>
